...
The symbolic field is usually not the unit of analysis. The workbench analyzes symbolic orders within symbolic fields.
...
- defines a collective body
- claims legitimacy
- ranks values
- authorizes or constrains sacrifice

False positives: symbols, rituals, names, affinity, traditions, rules, and brands are not sufficient by themselves.
...
Pathological sacrifice is coerced, concealed, unbounded, self-mutilating, or ordered toward preserving the symbolic order at the expense of persons.
...
Do not claim symbolic orders literally have minds.
