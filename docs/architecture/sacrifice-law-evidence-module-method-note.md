...
| American Revolution | Proposed as `american-revolution`; case folder follow-up required |
...
1. **Case coverage:** American Revolution and Napoleon have proposed PPW IDs but no case folders yet.
